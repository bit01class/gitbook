...
{% code title="com.bit.interceptor.MyInterceptor.java" %}
```java
...
{% code title="/WEB-INF/spring/appServlet/servlet-context.xml" %}
```markup
<interceptors> 
    <interceptor> 
        <!-- 인터셉터가 적용될 URL 입니다. --> 
